# [TODO-LIST](https://lakshmi-321.github.io/TODO-LIST/)

This is a simple To-Do List application built using **ReactJS**. It allows users to add, edit, and delete tasks, helping them manage their daily activities efficiently.
## Features

- **Add Tasks**: Users can add new tasks to their to-do list.
- **Edit Tasks**: Tasks can be edited to make any necessary changes.
...
If you want to contribute to the project, feel free to submit a pull request or open an issue on the repository.
